...
/// Use this to avoid throwing exceptions for expected failure paths.
/// </summary>
public class Result
{
    ...
    /// <summary>The error associated with a failed result. <see cref="Error.None"/> on success.</summary>
